  ...
  <layout>
    <ui-container>
      ...
      <div class="container" style="margin-top:2rem">
        <div class="text-4xl font-bold" style="text-align:center; color: #12b98aeb; font-size:1.55rem; font-weight:bolder">¿Qué acción desea realizar?</div>
