...
export default {
    props: ['filters', 'date', 'groupedSchedules', 'patient'],
    ...
    methods: {
        ...
        back() {
            this.$inertia.visit(route("multipleBooking.pickDay", this.patient));
        },

        onPicked(scheduleItem) {
            this.loading = true;

            const url = route("multipleBooking.postTime", this.patient);
